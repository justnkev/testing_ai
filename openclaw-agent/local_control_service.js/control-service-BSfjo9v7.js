...
import { r as loadConfig } from "./config-DxJyvt4o.js";
import { a as resolveBrowserConfig, o as resolveProfile, t as createBrowserRouteContext } from "./server-context-CM_E6wD5.js";
import { S as ensureChromeExtensionRelayServer } from "./errors-DdT2Dtkb.js";
...
async function stopBrowserControlService() {
	...
	state = null;
	try {
		await (await import("./pw-ai-BC4dLE7k.js")).closePlaywrightBrowserConnection();
	} catch {}
}
